...
curlyTags.extend(curlyTags,{
	...
	/*
	 * Performs all ajax calls and also has built in caching support, depending on the browser.
	 * This makes use of the html5 localStorage feature if the browser supports it.
	 */
